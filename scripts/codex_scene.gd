...
func _style_lists() -> void:
	...
	_monster_list.add_theme_stylebox_override("panel", bg)
	_monster_list.add_theme_color_override("font_color", Color(0.85, 0.85, 0.9))
	_monster_list.fixed_icon_size = Vector2i(32, 32)
